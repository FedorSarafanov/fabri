...
\xdef\p{20.55}
\xdef\N{1}
\addplot[name path=psinus1,sin,domain={-\Rad+\Shift+0.055:\Rad-\Shift-0.055},samples=400] {\wo*sqrt(1+(\coeff*x/\wo^2)^2)*sin((abs(x)<\lefft?\omegga*\N:\omegga)*x/(1/\p*(abs(x)-\p))/2+\phhi)*(abs(x)<\lefft?\scr:1)} node[pos=.8, above]{};

\addplot[name path=psinus2,sin,domain={-\Rad+\Shift+0.055:\Rad-\Shift-0.055},samples=400] {-\wo*sqrt(1+(\coeff*x/\wo^2)^2)*sin((abs(x)<\lefft?\omegga*\N:\omegga)*x/(1/\p*(abs(x)-\p))/2+\phhi)*(abs(x)<\lefft?\scr:1)} node[pos=.8, above]{}; 
